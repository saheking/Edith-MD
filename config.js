...
module.exports = {
  SESSION_ID: process.env.SESSION_ID || "EDITH~Z2ik",
  ...
  STICKER_NAME: process.env.STICKER_NAME || "Αԃɳαɳƙιɳɠ-ⱮԂ",
  CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
  CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
  DELETE_LINKS: process.env.DELETE_LINKS || "false",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923253617422",
  OWNER_NAME: process.env.OWNER_NAME || "Αԃɳαɳƙιɳɠ-ⱮԂ",
  DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Bandaheali*",
  ALIVE_IMG: process.env.ALIVE_IMG || "https://ibb.co/r9wMP9t",
  LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *Αԃɳαɳƙιɳɠ-ⱮԂ*⚡",
 ...
 BOTMODE: process.env.BOTMODE || "button",
  ...
  ANTI_MEDIA: process.env.ANTI_MEDIA || "true",
